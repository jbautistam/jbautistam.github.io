...
[MD5](/articles/seguridad/obtener-el-valor-md5-de-una-cadena/obtener-el-valor-md5-de-una-cadena)
y el [SHA1](/articles/seguridad/obtener-valor-sha1/obtener-valor-sha1) de una cadena. El resto de sistemas
...
![Tabla de usuario y contraseña con MD5](/articles/seguridad/almacenamiento-contrasenas/tabla-usuario-contrasena-md5.jpg "Tabla de usuario y contraseña con MD5")
...
![Envío del resultado de la función hash sobre la contraseña](/articles/seguridad/almacenamiento-contrasenas/envio-hash.jpg "Envío del resultado de la función hash sobre la contraseña")
...
![Colisiones con sistemas SHA1](/articles/seguridad/almacenamiento-contrasenas/collision-sha1.jpg "Colisiones con sistemas SHA1")
...
![Ejemplo de tabla rainbow](/articles/seguridad/almacenamiento-contrasenas/tabla-rainbow.jpg "Ejemplo de tabla rainbow")
...
![Tabla de usuario / hash con IV](/articles/seguridad/almacenamiento-contrasenas/tabla-iv.jpg "Tabla de usuario / hash con IV")
...
![Envío de hash utilizando IV](/articles/seguridad/almacenamiento-contrasenas/envio-iv-hash.jpg "Envío de hash utilizando IV")
