...
Continuando con el [motor de pruebas de base de datos](/articles/source-code/pruebas-base-datos/pruebas-base-datos)
...
Por ahora eso es todo. En el [siguiente artículo](/articles/source-code/pruebas-base-datos-iii/pruebas-base-datos-iii)
