...
En el [artículo anterior](/articles/source-code/pruebas-base-datos-ii/pruebas-base-datos-ii), expliqué cómo utilizar
...
Como decíamos en el [primer artículo de esta serie](/articles/source-code/pruebas-base-datos/pruebas-base-datos), lo normal
