...
![Activar o desactivar las características de Windows](/articles/big-data/instalacion-spark/images/Caracteristicas-de-Windows.jpg "Activar o desactivar las características de Windows")
...
![Ubuntu](/articles/big-data/instalacion-spark/images/Ubuntu.jpg "Ubuntu")
...
![Página de descargas de Spark](/articles/big-data/instalacion-spark/images/Download-spark.jpg "Página de descargas de Spark")
...
![Interface de usuario de master](/articles/big-data/instalacion-spark/images/Spark-UI-master.jpg "Interface de usuario de master")
...
![Interface de usuario con un nodo master y otro worker](/articles/big-data/instalacion-spark/images/Spark-UI-Worker.jpg "Interface de usuario con un nodo master y otro worker")
...
![Shell de Spark](/articles/big-data/instalacion-spark/images/Spark-shell.jpg "Shell de Spark")
...
![Pyspark](/articles/big-data/instalacion-spark/images/Pyspark.jpg "Pyspark")
...
![Interface de usuario Thrift](/articles/big-data/instalacion-spark/images/Thrift-UI.jpg "Interface de usuario Thrift")
...
![Spark Sql](/articles/big-data/instalacion-spark/images/Spark-sql.jpg "Spark Sql")
...
![Conexión a Spark con Dbeaver](/articles/big-data/instalacion-spark/images/Conexion-dbeaver.jpg "Conexión a Spark con Dbeaver")
			
y la configuramos:

![Configuracion de la conexión con Dbeaver](/articles/big-data/instalacion-spark/images/Configuracion-dbeaver.jpg "Configuracion de la conexión con Dbeaver")
...
![Dbeaver conectado a Spark](/articles/big-data/instalacion-spark/images/Dbeaver-con-Spark.jpg "Dbeaver conectado a Spark")
...
![Resultado consulta con Dbeaver](/articles/big-data/instalacion-spark/images/dbeaver-query.jpg "Resultado consulta con Dbeaver")
		
También podemos ir a la consola de Thrift para ver cómo se ha ejecutado todo:

![Información sobre procesos de Thrift](/articles/big-data/instalacion-spark/images/Thrift-jobs.jpg "Información sobre procesos de Thrift")
