...
Nuestra solución pasa por programar directamente en [Spark Sql en local](/articles/big-data/instalacion-spark/instalacion-spark)
...
![DROP TABLE en Databricks](/articles/big-data/cositas-databricks/images/Error-drop-table.jpg "Instrucción DROP TABLE en Databricks")
...
![Databricks Isolation levels](/articles/big-data/cositas-databricks/images/Isolation-levels.jpg "Isolation levels")
