...
[BauDbStudio](/applications/baudbstudio/manual/001-tutorial-baudbstudio/001-tutorial-baudbstudio), cuánto más ejecuto contra Spark Sql, más me
...
Como se puede ver, es una mezcla entre los [scripts de SQL](/applications/baudbstudio/manual/040-scripts-sql/040-scripts-sql) que teníamos
...
[Spark.Net](/articles/big-data/experimento-spark-net/experimento-spark-net) con C# pero no creo que por hoy por hoy tenga los conocimientos
