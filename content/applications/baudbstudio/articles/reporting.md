...
![Esquema de base de datos](/applications/baudbstudio/articles/ReportingDbSchema.jpg "Esquema de la base de datos de informes")
...
![Tabla FactSales](/applications/baudbstudio/articles/FactSalesTable.jpg "Campos de la tabla FactSales")
...
![Tabla DimCustomers](/applications/baudbstudio/articles/DimCustomersTable.jpg "Campos de la tabla DimCustomers")
...
![Tabla DimLocations](/applications/baudbstudio/articles/DimLocationsTable.jpg "Campos de la tabla DimLocations")
...
![Modelo de copo de nieve](/applications/baudbstudio/articles/SnowflakeModel.jpg "Modelo de copo de nieve")
...
![Estructura de metadatos](/applications/baudbstudio/articles/Metadata.jpg "Metadatos")
...
![Consulta sobre el informe de ventas](/applications/baudbstudio/articles/QuerySales.jpg "Consulta de informe")

Nos abrirá una pantalla de ejecución del informe:

![Ventana del informe de ventas](/applications/baudbstudio/articles/QuerySalesWindow.jpg "Informe de ventas")
...
![Consulta sencilla de expresiones](/applications/baudbstudio/articles/QuerySalesExpressions.jpg "Consulta de expresiones")
...
![Consulta de expresiones con suma](/applications/baudbstudio/articles/QuerySalesExpressionsSum.jpg "Suma de precios ordenado por fecha")
...
![Consulta con dimensiones](/applications/baudbstudio/articles/QuerySalesDimensions.jpg "Consulta con dimensiones")

Ahora filtremos por los clientes de *Lyon*, para ello añadimos un filtro sobre la ciudad del cliente:

![Filtro por la ciudad del cliente](/applications/baudbstudio/articles/FilterCustomerCity.jpg "Filtro de clientes")

Y ejecutamos:

![Consulta con dimensiones filtrado](/applications/baudbstudio/articles/QuerySalesDimensionsFiltered.jpg "Consulta filtrada con dimensiones")
...
![Consulta con categoría de producto](/applications/baudbstudio/articles/QuerySalesDimensionsProductFiltered.jpg "Consulta filtrada con categoría")
...
![Filtro sobre la suma de precios](/applications/baudbstudio/articles/FilterPriceHaving.jpg "Filtro HAVING")

Y ejecutamos:

![Consulta con filtro sobre la suma de precios](/applications/baudbstudio/articles/QuerySalesDimensionsProductHaving.jpg "Consulta con un filtro para el total")

Por supuesto, también podemos hacer nuestro pequeño gráfico del resultado aunque aún no estoy muy orgulloso de él:

![Gráfico del resultado de la consulta](/applications/baudbstudio/articles/QueryChart.jpg "Gráfico")
