...
Mientras escribimos [scripts de SQL](/applications/baudbstudio/manual/040-scripts-sql/040-scripts-sql) o
investigamos el contenido de una [conexión](/applications/baudbstudio/manual/020-conexiones/020-conexiones)
...
![Consulta sobre una tabla](/applications/baudbstudio/manual/090-consultas/consultatabla.jpg "Consulta sobre una tabla")
...
![Barra de herramientas de consulta](/applications/baudbstudio/manual/090-consultas/barraherramientas.jpg "Barra de herramientas de consulta")
...
ejecutar [scripts de SQL](/applications/baudbstudio/manual/040-scripts-sql/040-scripts-sql) y 
[scripts de ETL](/applications/baudbstudio/manual/120-scripts-etl/120-scripts-etl), pero no las consultas de esta ventana. Para ejecutar
...
![Visualización de resultados](/applications/baudbstudio/manual/090-consultas/resultadosconsulta.jpg "Visualización de resultados consulta")
...
![Plan de ejecución](/applications/baudbstudio/manual/090-consultas/planejecucion.jpg "Plan de ejecución de una consulta")
...
![Gráfico](/applications/baudbstudio/manual/090-consultas/graficoconsulta.jpg "Gráfico de una consulta")

Además, el botón de **Guardar** nos permite guardar el resultado de la consulta en un archivo 
[CSV o parquet](/applications/baudbstudio/manual/095-archivos-de-datos/095-archivos-de-datos) mientras que el botón de
...
[archivo de parámetros](/applications/baudbstudio/manual/045-archivos-de-parametros/045-archivos-de-parametros) que los
...
![Resultado de una consulta](/applications/baudbstudio/manual/090-consultas/resultadosconsultaparametros.jpg "Resultado de una consulta con parámetros sobre SqLite")
...
Del mismo modo que en la ventana de [edición de scripts](/applications/baudbstudio/manual/040-scripts-sql/040-scripts-sql),
