...
En mi caso, instalé [Spark sobre WSL](/articles/big-data/instalacion-spark/instalacion-spark) en mi equipo y la versión de
...
![Conectar al servidor Thrift Server](/applications/baudbstudio/manual/025-conexion-spark/servidor-odbc-spark.jpg "Conectar al servidor Thrift Server de Spark para ODBC")
...
![Conexiones ODBC de 64bits](/applications/baudbstudio/manual/025-conexion-spark/conexiones-odbc-64.jpg "Conexiones a orígenes de datos ODBC de 64bits de Windows")	
			
Y agregamos una conexión utilizando el driver:

![Creación de una conexion ODBC](/applications/baudbstudio/manual/025-conexion-spark/conexion-odbc-spark.jpg "Creación de una conexion a ODBC Spark")
...
![Conexion de ejemplo](/applications/baudbstudio/manual/025-conexion-spark/conexion-odbc-spark-sample.jpg "Conexion de ejemplo al servidor ODBC de Spark")
...
[conexión](/applications/baudbstudio/manual/020-conexiones/020-conexiones) a nuestro servidor en BauDbStudio.
...
![Conexión a un servidor ODBC de Spark](/applications/baudbstudio/manual/025-conexion-spark/conexion-spark-baudbstudio.jpg "Conexión a un servidor ODBC de Spark utilizando BauDbStudio")	
...
![Consulta sobre un servidor Spark](/applications/baudbstudio/manual/025-conexion-spark/consulta-spark.jpg "Consulta sobre un servidor Spark utilizando ODBC en BauDbStudio")