...
Uno de mis proyectos personales del año pasado fue [DevConference](/applications/devconference/devconference) con **UWP**:
...
Si queréis, podéis consultar la información sobre la aplicación en el [artículo anterior](/applications/devconference/devconference) y
