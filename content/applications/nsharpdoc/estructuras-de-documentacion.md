...
Como hemos explicado en otras secciones de esta Web, [NSharpDoc](/applications/nsharpdoc/nsharpdoc) es un
...
[proveedores de documentación](/applications/nsharpdoc/proveedores-de-nsharpdoc)
...
[motor de plantillas](/applications/nsharpdoc/plantillas-de-nsharpdoc/plantillas-de-nsharpdoc) que genera los documentos finales.
...
[plantillas](/applications/nsharpdoc/plantillas-de-nsharpdoc/plantillas-de-nsharpdoc) para generar la documentación de cada
...
del [proveedor](/applications/nsharpdoc/proveedores-de-nsharpdoc) define sus propios tipos y el diseñador
de [plantillas](/applications/nsharpdoc/plantillas-de-nsharpdoc/plantillas-de-nsharpdoc) utiliza estos tipos para definir las salidas.

Este juego de estructuras / plantillas es lo que convierte a [NSharpDoc](/applications/nsharpdoc/nsharpdoc) en un generador 
